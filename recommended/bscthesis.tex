...
\vspace*{\fill}
\begin{center}
A dissertation submitted for the Council of Scientific Students’ Associations\bigskip
...
\input{chapters/introduction}	% 2-5 oldal
\clearpage
\input{chapters/literature}		% minimum 10 oldal
\clearpage
%% BEVEZETÉS
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
%% TARTALOM
\input{chapters/design}	% 10 oldal
\clearpage
