...
\paragraph{Activation Layer.} To have a better grasp on how to extend the rules \ref{eq:addition, eq:multiply, eq:chain} for neural networks in practice, consider a 