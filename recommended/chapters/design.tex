...
$$e_i = \frac{\exp(y_i)}{|\exp(y)|_1}$$
Conventionally the corresponding Loss function is the \textbf{log-loss} or \textbf{cross-entropy} function, and its gradient w.r.t. the original response of the last layer $y$ is:
\begin{equation}
\begin{split}
