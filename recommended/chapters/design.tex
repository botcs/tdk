...
\section{Special layers}
In this section I will introduce layers derived from the abstract \emph{activation layers}, 
...
In my implementation they can be only applied to fully-connected layers.



\subsection{k-WTA layers}
...
\subsection{Layers as functioning units}
Taking into account the functions of a general layer, I have 

\subsection{Network as a container}
an object that arranges, connects 
