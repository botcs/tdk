...
\paragraph{Activation Layer.} To have a better grasp on how to extend the definitions \ref{eq:addition, eq:multiply, eq:chain} for neural networks in practice, consider a 