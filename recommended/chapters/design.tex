...
\item RMSProp: $r_{(n+1)}=(1-\epsilon)r_n + \epsilon\left(\nabla_{\phi_n}\mathcal{L}\right)^2$ \cite{rmsprop}
\item Adam: Combination of RMSProp and momentum \cite{kingma2014adam}.
\end{itemize}
Second order derivative e.g. Conjugate gradient \cite{shewchuk1994introduction}.
