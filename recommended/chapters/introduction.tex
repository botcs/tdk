...
However, as a byproduct, further questions arise, for which pure logical (mathematical?) solution is not available, or the problem is larger than to be solved by current ones.
...
Such a simple paradigm is playing a fundamental role in boosting the industry and researches of today, because introducing Machine Learning to many fields of life seems to results in great leap forward. 
